...
(function() {
  ...
  var translations = {
    ...
    'styling.neutral': { ko: '젠더리스', en: 'Non-binary' },
    ...
    'styling.undertone_warm': { ko: '웜톤 (Warm)', en: 'Warm' },
    'styling.undertone_warm_desc': { ko: '손목 혈관이 초록빛, 금색 액세서리가 잘 어울림', en: 'Greenish wrist veins, gold accessories suit well' },
    'styling.undertone_cool': { ko: '쿨톤 (Cool)', en: 'Cool' },
    'styling.undertone_cool_desc': { ko: '손목 혈관이 파란빛, 은색 액세서리가 잘 어울림', en: 'Bluish wrist veins, silver accessories suit well' },
    'styling.undertone_neutral': { ko: '뉴트럴 (Neutral)', en: 'Neutral' },
    'styling.undertone_neutral_desc': { ko: '두 가지 톤이 섞여 있음, 모든 금속이 어울림', en: 'Mixed tones, all metals suit well' },
