...
(function() {
  ...
  var translations = {
    ...
    'features.pillar3_btn': { ko: '간직하기 · STORE', en: 'CHERYSH' },
    ...
    'shop.cat_lightstick': { ko: '기억의 등불 (Lightstick)', en: 'Lantern of Memory (Lightstick)' },
    'shop.cat_lightstick_title': { ko: '나만의 기억의 등불 · 커스텀 굿즈', en: 'My Lantern of Memory · Custom Goods' },
    ...
    'shop.lightstick_custom': { ko: '커스텀 기억의 등불', en: 'Custom Lantern of Memory' },
    ...
    'lightstick.step1_html': { ko: '기억의 등불 속에<br><strong>당신의 진심</strong>을 각인하다', en: 'Engrave <strong>your sincere heart</strong><br>on the lantern of memory' },
    ...
    'lightstick.modal_step1_desc': { ko: '소중한 마음을 담아, 기억의 등불에 새길 이름이나 서명을 입력하세요', en: 'With all your heart, enter the name or signature to engrave on your lantern' },
    ...
    'lightstick.modal_step3_title': { ko: '🤖 기억의 등불 디자인', en: '🤖 Lantern of Memory Design' },
    ...
    'arch.nano_loading': { ko: '나노 바나나가 당신의 선율을 해석하여 안식처의 기둥을 세우고 있습니다...', en: 'Nano Banana is interpreting your melody to raise the pillars of your sanctuary...' },
    ...
    'arch.upload_midi_pdf': { ko: '음악의 기록(MIDI/PDF/악보) 업로드', en: 'Upload Music Records (MIDI/PDF/Sheet)' },
    ...
    'arch.result_building_desc': { ko: '나노 바나나가 당신의 주파수를 영원한 안식처로 빚어냅니다', en: 'Nano Banana crafts your frequency into an eternal sanctuary' },
