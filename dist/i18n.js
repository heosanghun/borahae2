...
(function() {
  ...
  var translations = {
    ...
    'hero.ai_suggestion': {
      ko: '<strong>OpenAI</strong>가 빚어내는 당신만의 보라빛 세계, 지금 <strong>OpenAI</strong>와 함께 시작하세요',
      en: 'Your purple universe, powered by <strong>OpenAI</strong> — Start with <strong>OpenAI</strong> now'
    },
